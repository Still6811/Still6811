...
QT_MOC_LITERAL(4, 26, 9) // "onClicket"

    },
    "mylabel\0clicked\0\0sendData\0onClicket"
};
...
void mylabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendData((*reinterpret_cast< QRect(*)>(_a[1]))); break;
        case 2: _t->onClicket(); break;
        default: ;
        }
        ...
        {
            typedef void (mylabel::*_t)(QRect );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mylabel::sendData)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void mylabel::sendData(QRect _t1)
{
